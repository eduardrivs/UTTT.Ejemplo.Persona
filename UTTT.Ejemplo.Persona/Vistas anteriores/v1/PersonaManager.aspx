        ...
        <form runat="server">
            ...
            <div class="row mt-5">
                ...
                <div class="mt-1 row justify-content-center">
                    <div class="col-md-5 text-end row justify-content-end">
                        <div class="col-md-8 text-end">
                            <asp:RegularExpressionValidator ID="revFechaNacimiento" runat="server" class="text-danger" ErrorMessage="&quot;La fecha es incorrecta&quot;" ValidationExpression="^(?:3[01]|[12][0-9]|0?[1-9])(\/)(0?[1-9]|1[1-2])\1\d{4}$" ControlToValidate="txtFechaNacimiento" ValidationGroup="gvSave"></asp:RegularExpressionValidator>
                        </div>
                        <div class="col-md-4 text-start">
